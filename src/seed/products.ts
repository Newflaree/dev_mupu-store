export const productsDB = [
  // GNSS X5
  {
    ...
    category: 'gnss-x5',
    description: 'El receptor de antena GNSS externo de alta precisión que funciona con tu smartphone o tableta Android o iOS. La solución perfecta para usuarios profesionales tanto principiantes como con experiencia en campo. Cuenta con un sistema de corrección NTRIP que recibe datos a través de Internet o Bluetooth. Tiene un indicador láser de punto rojo para facilitar el uso en levantamientos geodésicos.',
  ...
  },
  {
    ...
    category: 'gnss-x5',
    description: 'Estación base y Rover para soluciones fijas PPK, RTK y NTRIP. Con solo unos minutos de configuración, el X5R es uno de los métodos más rápidos para tomar mediciones de grado centimétrico. Funciona con software GIS común, incluyendo SW Maps, SurvPC, Field Genius y muchos otros.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704765865/demos/muputun/new-products-cretificategoryd/X5%20Receptor%20GNSS%20Multibanda%20-%20CON%20CERTIFICACION/cmqvmmelrc8psumrws03.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704765865/demos/muputun/new-products-cretificategoryd/X5%20Receptor%20GNSS%20Multibanda%20-%20CON%20CERTIFICACION/cmqvmmelrc8psumrws03.jpg',
    mainAdv: [
      {
  ...
  },
  {
    ...
    category: 'gnss-x5',
    description: 'El Módulo X5 PPK para Phantom 4 Pro es un sistema adaptador GNSS no intrusivo para conectarse a un Drone DJI Phantom 4 Pro v.1/v.2 o Advance (no incluido). Posicionamiento con precisión de centímetros en PPK. Para mapeo UAV preciso con menos GCPs. El módulo X5 PPK está listo para usar, y no se necesita configuración, puedes descriptionargar los datos RAW de la tarjeta SD',
  ...
  },
  {
    ...
    category: 'gnss-x5',
    description: 'El Módulo X5 PPK para Mavic 2 Pro es un sistema adaptador GNSS no intrusivo para conectarse a un Drone DJI Mavic 2 Pro (no incluido). Posicionamiento con precisión de centímetros en PPK. Para mapeo UAV preciso con menos GCPs. El módulo X5 PPK está listo para usar, y no se necesita configuración, puedes descriptionargar los datos RAW de la tarjeta SD o vía Wi-Fi',
  ...
  },
  {
    ...
    name: 'X5 Radio LoRa',
    category: 'gnss-x5',
    description: 'Haz que tu X5R sea compatible con Trimble SPS855 y otras Estaciones Base GNSS a través de la comunicación LoRa. El radio X5 LoRa es un sistema adaptador que trabaja con una potencia de 1W para que tu Receptor X5 obtenga correcciones GNSS de cualquier Estación Base GNSS que use este protocolo.',
  ...
  },
  {
    ...
    name: 'HeliX5 Antena',
    category: 'gnss-x5',
    description: 'El receptor de antena GNSS externo de alta precisión que funciona con tu smartphone o tableta Android o iOS. La solución perfecta para usuarios profesionales tanto principiantes como experimentados en campo, con correcciones RTK+PPK+NTRIP. Cuenta con un sistema de corrección NTRIP que recibe datos a través de Internet o Bluetooth y un sistema de corrección RTK que recibe datos a través de LoRa.',
  ...
  },
  {
    ...
    category: 'soft-se',
    description: 'SurPad es una aplicación para Android diseñada para profesionales que utilizan receptores GPS/GNSS RTK y estaciones totales. Es especialmente útil para topógrafos, cartógrafos, ingenieros, arquitectos y planificadores urbanos. Cuenta con una amplia gama de herramientas y capacidades que permiten a los usuarios combinar eficientemente el control RTK, la recolección de datos GIS y la planificación de carreteras en una interfaz amigable para el usuario.',
  ...
  },
  {
    ...
    category: 'combos',
    description: 'El combo GNSS Receptor X5 + SurPad App integra la avanzada tecnología del Receptor GNSS Multibanda X5 con la aplicación SurPad 4.2 para Android, ofreciendo una solución completa y eficiente para profesionales en topografía, cartografía, ingeniería y planificación urbana. Esta combinación es ideal para realizar mediciones de grado centimétrico y optimizar proyectos de campo.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704765853/demos/muputun/new-products-cretificategoryd/GNSS%20Receptor%20X5%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/ylk6ugkknrl1vvxdzfco.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704765853/demos/muputun/new-products-cretificategoryd/GNSS%20Receptor%20X5%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/ylk6ugkknrl1vvxdzfco.jpg',
    mainAdv: [
      {
    ...
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765855/demos/muputun/new-products-cretificategoryd/GNSS%20Receptor%20X5%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/y7kjfsv2lmworsecdd24.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765855/demos/muputun/new-products-cretificategoryd/GNSS%20Receptor%20X5%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/y7kjfsv2lmworsecdd24.jpg'
  ...
  },
  {
    ...
    category: 'combos',
    description: 'El combo GNSS Receptor X5 + SurPad App integra la avanzada tecnología del Receptor GNSS Multibanda X5 con la aplicación SurPad 4.2 para Android, ofreciendo una solución completa y eficiente para profesionales en topografía, cartografía, ingeniería y planificación urbana. Esta combinación es ideal para realizar mediciones de grado centimétrico y optimizar proyectos de campo.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704765856/demos/muputun/new-products-cretificategoryd/2%20Unidades%20X5%20Receptor%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/p2kw6ktd44e8squhk0th.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704765856/demos/muputun/new-products-cretificategoryd/2%20Unidades%20X5%20Receptor%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/p2kw6ktd44e8squhk0th.jpg',
    mainAdv: [
      {
        advItem: 'Módulo GNSS independiente con capacidades avanzadas para mediciones de grado centimétrico.'
      },
    ...
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765852/demos/muputun/new-products-cretificategoryd/2%20Unidades%20X5%20Receptor%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/jvqe3kt0uzmuw1z6kfbx.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765852/demos/muputun/new-products-cretificategoryd/2%20Unidades%20X5%20Receptor%20%2B%20SurPad%20App%20-%20CON%20CERTIFICACION/jvqe3kt0uzmuw1z6kfbx.jpg'
  ...
  },
  {
    ...
    category: 'combos',
    description: 'Disfrute de nuestro pack de accesorios a un precio imperdible y no se pierda la oportunidad de tener calidad de soporte para sus equipos.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704765861/demos/muputun/new-products-cretificategoryd/ICONO%20PACK%20ACCESORIOS/xqzuudwculdxqejcp6kc.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704765861/demos/muputun/new-products-cretificategoryd/ICONO%20PACK%20ACCESORIOS/xqzuudwculdxqejcp6kc.jpg',
    mainAdv: [],
    techSpecs: [],
    includes: [
    ...
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765859/demos/muputun/new-products-cretificategoryd/ICONO%20PACK%20ACCESORIOS/hzs598syxgzubj3vdb9s.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765857/demos/muputun/new-products-cretificategoryd/ICONO%20PACK%20ACCESORIOS/p2whoyjtdftuumrqsmby.jpg'
      },
    ],
    price: '440.000',
  ...
  // Accesories
  {
    ...
    category: 'acce',
    description: 'Trípode Fabricado con una mezcla de madera y fibra de madera que da el peso y estabilidad necesaria para soportar los equipos GNSS, estaciones totales y teodolitos que utilizas en tus proyectos, su doble seguro impide desplazamientos de sus patas alcanzando una nivelada estable. Incluye protección de plato.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704840701/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/gr9u9etsduz8r5hwkj4v.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704840701/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/gr9u9etsduz8r5hwkj4v.jpg',
    mainAdv: [],
    techSpecs: [],
    includes: [],
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765861/demos/muputun/new-products-cretificategoryd/ICONO%20TRIPODE/djtadmn5ltofcrpzddc1.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765863/demos/muputun/new-products-cretificategoryd/ICONO%20TRIPODE/mj13rqtxgsfhvfmlm6qi.jpg'
      },
    ],
    price: '145.000',
  ...
  },
  {
    ...
    name: 'Jalón de Fibra de Carbono',
    category: 'acce',
    description: 'Soporta equipos y accesorios con un hilo de rosca de 5/8. Presenta doble seguro y orificios para uno de estos en medidas específicas para trabajar de forma más segura y nivelada gracias a su burbuja de nivel esférico incorporada. Incluye bolso de transporte.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704765854/demos/muputun/new-products-cretificategoryd/ICONO%20JALON/z07scjqrgldq1lt3lypf.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704765854/demos/muputun/new-products-cretificategoryd/ICONO%20JALON/z07scjqrgldq1lt3lypf.jpg',
    mainAdv: [],
    techSpecs: [],
    includes: [],
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765857/demos/muputun/new-products-cretificategoryd/ICONO%20JALON/ydnpnwnjpuwzocgkmguu.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765858/demos/muputun/new-products-cretificategoryd/ICONO%20JALON/xlscyscufwbrcfvkfpqr.jpg'
      },
    ],
    price: '145.000',
  ...
  },
  {
    ...
    name: 'Adaptador Base Tribrach Negra',
    category: 'acce',
    description: 'Permite el trabajo con bases GNSS y fácil montaje de estas gracias a su rosca 5/8 extraible.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704840686/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/gam0s7j9ymeorbonv61x.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704840686/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/gam0s7j9ymeorbonv61x.jpg',
    mainAdv: [],
    techSpecs: [],
    includes: [],
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765853/demos/muputun/new-products-cretificategoryd/ICONO%20ADAPTADOR/st6qamfnk3xm3fympjza.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765853/demos/muputun/new-products-cretificategoryd/ICONO%20ADAPTADOR/vsiok9dxf7szfvn8kqeo.jpg'
      },
    ],
    price: '35.000',
  ...
  },
  {
    ...
    name: 'Base Tribrach Negra',
    category: 'acce',
    description: 'Permite el trabajo con equipos topográficos varios. plomada óptica, burbuja de nivel esférico, seguro giratorio, tres enganches para adaptador, y tres tornillos nivelantes finos.',
    banner: 'https://res.cloudinary.com/newflare/image/upload/v1704840693/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/ub3donqiucjvahqulsxl.jpg',
    bannerM: 'https://res.cloudinary.com/newflare/image/upload/v1704840693/demos/muputun/new-products-cretificategoryd/PORTADA%20CON%20CERTIFICACION%20EN%20PNG/ub3donqiucjvahqulsxl.jpg',
    mainAdv: [],
    techSpecs: [],
    includes: [],
    imgs: [
      { 
        name: 'img-1',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765860/demos/muputun/new-products-cretificategoryd/ICONO%20BASE%20NIVELANTE/jobqbzvpozo3gvybncku.jpg'
      },
      { 
        name: 'img-2',
        url: 'https://res.cloudinary.com/newflare/image/upload/v1704765855/demos/muputun/new-products-cretificategoryd/ICONO%20BASE%20NIVELANTE/j9ja83b4kzpeuq5bvhzw.jpg'
      },
    ],
    price: '100.000',
